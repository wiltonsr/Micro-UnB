...
\begin{itemize}
\item Mostrar sinal luminoso intermitente que fica ativo sempre que não houver outro sinal
\item Mostrar seta para a direita ou para a esquerda após clique do botão correspondente
\item Mostrar informação sobre intenção de parada
\item Mostrar feixe de luz que delimita o espaço da bicicleta
\end{itemize}
